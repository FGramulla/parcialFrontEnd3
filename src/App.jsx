  ...
  return (
    <div className="App">
      <form onSubmit={submitHandler}>
        ...
        {!isNameOk && <p className='errorMessage'>Por favor revisa que la información sea la correcta</p>}

        <label htmlFor="">País: </label>

        <input type="text" value={country} onChange={countryOnChange} className={!isCountryOk ? "error" : ""} />

        {!isCountryOk && <p className='errorMessage'>Por favor revisa que la información sea la correcta</p>}

        <select name="" id="" onChange={codeOnChange} value={code}>

          <option>Selecione la bandera</option>
